  ...
  <div class="container">
    ...
    <div class="table-top">
      ...
      <div class="add-box">
        ...
        <n-upload action="http://localhost:8080/excel/upload/teacher" @finish="handleFinish"
    ...
    <n-drawer-content title="修改/新增" closable>
      <n-form ref="formRef" :model="form" label-placement="left" :label-width="70" :style="{
        ...
        <n-form-item label="工号">
          <n-input placeholder="" v-model:value="form.tid" />
        </n-form-item>
...
import { listTeachersByQuery, saveTeacher } from "@/api"
...
const handleSearch = () => {
  listTeachersByQuery(query).then(res => {
    data.value = res.data
  })
}
