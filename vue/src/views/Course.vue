        ...
        <div class="table-top">
            <div class="search-box">
                <n-form ref="formRef" inline :label-width="80" :model="query">
                    <n-form-item label="课程名称" path="query.name">
                        <n-input placeholder="输入课程名称" v-model:value="query.name" />
                    </n-form-item>
                    <n-form-item label="先行课" path="query.fcid">
                        <n-input placeholder="输入先行课的课号 " v-model:value="query.fcid" />
                    </n-form-item>
                    <n-form-item>
            ...
            <div class="add-box">
                ...
                <n-upload action="http://localhost:8080/excel/upload/course" @finish="handleFinish"
        ...
        <n-drawer-content title="修改/新增" closable>
            <n-form ref="formRef" :model="form" label-placement="left" :label-width="70" :style="{
              maxWidth: '280px'
                ...
                <n-form-item label="课号">
                    <n-input placeholder="" v-model:value="form.cid" />
                </n-form-item>
                <n-form-item label="课名">
                    <n-input placeholder="" v-model:value="form.name" />
                </n-form-item>
                <n-form-item label="学分">
                    <n-input placeholder="" v-model:value="form.credit" />
                </n-form-item>
                <n-form-item label="先行课">
                    <n-input placeholder="" v-model:value="form.fcid" />
                </n-form-item>
...
import { listCoursesByQuery, saveCourse } from "@/api"
